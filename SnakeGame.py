...
from pygame.examples.go_over_there import screen, clock, running

pygame.init()
## screen display from the game
...
def reset_game():
    ...
    score = 0
## set the running true if the program is running
running = True
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            running = False
    ## key strokes of the snakes when pressed
